# Graph Report - tidl_webiste  (2026-07-19)

## Corpus Check
- 241 files · ~6,553,830 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1870 nodes · 3082 edges · 259 communities (129 shown, 130 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6695b849`
...
## Communities (259 total, 130 thin omitted)

### Community 0 - "Checkout and Site Header"
Cohesion: 0.25
Nodes (6): FAQ_DATA, FaqItem, HOME_PULSE, HERO_COPY, HOMEPAGE_STARTING_PRICE_LABEL, PRODUCTS

### Community 1 - "App Routing and Pages"
Cohesion: 0.03
Nodes (75): PDP_META, getRouter(), Route, Route, Route, Route, Route, Route (+67 more)

### Community 2 - "Checkout UI Components"
Cohesion: 0.13
Nodes (14): catCardHover, catReveal, catSpring, catStagger, CategoryAfterSection(), CategoryAfterSectionProps, CategoryBundleSection(), CategoryBundleSectionProps (+6 more)

### Community 3 - "Dynamic Quiz Logic"
Cohesion: 0.05
Nodes (71): PrxActivityCard(), CategoryWhySection(), CategoryWhySectionProps, formatMetric(), ProofMetric, protocolLabel(), answerMatches(), Answers (+63 more)
...
Cohesion: 0.22
Nodes (12): CategoryRecommendation, findAnswer(), getCategoryRecommendation(), resolveAction(), peptideToProduct(), GENERIC_FALLBACK_PRODUCT, GLP1_PRODUCT, GOAL_FALLBACK (+4 more)
...
Cohesion: 0.11
Nodes (29): CategoryAmbient(), CategoryFormularySection(), CategoryFormularySectionProps, resolvePdpSlug(), tileImage(), tilePrice(), CategoryPage(), CategoryPageProps (+21 more)
...
Cohesion: 0.12
Nodes (14): BeforeAfterSlider(), BeforeAfterSliderProps, PdpBeforeAfterSection(), PdpBeforeAfterSectionProps, TECH_STRIP, PdpCtaBand(), PdpCtaBandProps, PdpDataContext (+6 more)
...
Cohesion: 0.15
Nodes (20): GLP1_PDP_CONTENT, SHARED_CARE_FAQ, SHARED_DELIVERY_FAQ, SHARED_REVIEW_STATS, SHARED_SAFETY_PILLARS, SHARED_START_FAQ, HERO_IMAGES, getPdpContent() (+12 more)
...
Cohesion: 0.20
Nodes (11): getPeptideDef(), PEPTIDE_DEFS, ALL_ENCOUNTER_SLUGS, CATEGORY_ENCOUNTER_SLUGS, goalLabel(), HomeFeaturedPeptide, HomeSandboxData, loadHomeEncounters() (+3 more)
...
Cohesion: 0.26
Nodes (10): CATEGORY_NAME_RULES, countCatalogByCategory(), getUnmappedProductSlugs(), inferFormHint(), inferStrengthLabel(), isPenCatalogProduct(), mapSandboxProductToCategory(), matchMarketedSlugFromCatalogName() (+2 more)
...
Cohesion: 0.34
Nodes (10): STATUS_ORDER, StatusTimeline(), useIsMounted(), usePrxEncounterStatus(), prxStatusToOrderStatus(), getRecommendedTreatment(), useAuth(), AccountPage() (+2 more)
...
Cohesion: 0.29
Nodes (11): calculateOrderPricing(), approximateDobFromAge(), mapCheckoutToPatientAddressPayload(), mapCheckoutToPaymentPayload(), mapCheckoutToUnifiedIntakePayload(), mapQuizToConsents(), mapQuizToIntakeAnswers(), mapQuizToPatientPayload() (+3 more)
...
Cohesion: 0.15
Nodes (10): PdpButton(), PdpButtonProps, Reveal(), settle, IncludedLine(), PdpIncludedSection(), withPeriod(), PdpOutcomeSection() (+2 more)

### Community 79 - "Radix Hover Card Primitive"
Cohesion: 0.16
Nodes (18): addDays(), createOrder(), generateOrderNumber(), getLatestOrderForUser(), getOrderById(), getOrdersForUser(), readOrders(), writeOrders() (+10 more)
...
Cohesion: 0.20
Nodes (10): usePdpData(), PdpHowItWorks(), PdpUnderstandSection(), StartProps, WEIGHT_LOSS_DONE_PHRASES, FALLBACK_LINES, PdpMotivationMarquee(), PdpTransformationSection() (+2 more)
...
Cohesion: 0.18
Nodes (7): CategoryExperienceSection(), ease, Props, CategoryPenSectionProps, GLP1_PEN_SHOWCASE, PenShowcaseContent, CategorySlug

### Community 98 - "types.ts"
Cohesion: 0.15
Nodes (18): getPeptideImageMap(), resolvePeptideOnlyImage(), PrxCatalogPackage, PrxCatalogProduct, mergeSandboxIntoPdp(), usableLiveCopy(), buildState(), firstPositiveSandboxPrice() (+10 more)
...
Cohesion: 0.27
Nodes (6): TileCopy(), CategoryHero(), OrderSummary(), useLiveProduct(), formatCurrency(), getCatalogListPrice()
...
Cohesion: 0.11
Nodes (13): TidlWordmark(), TidlWordmarkProps, JOURNEY_TICKER_ICONS, JOURNEY_TICKER_ITEMS, JourneySection(), JourneySectionProps, CAREER_LINKS, COMPANY_LINKS (+5 more)

### Community 250 - "CategoryExperienceSection.tsx"
Cohesion: 0.40
Nodes (3): CareMosaicSection(), CareMosaicSectionProps, PATHWAYS

### Community 251 - "schema-intake.ts"
Cohesion: 0.50
Nodes (3): buildGallery(), PdpHeroSection(), PdpHeroSectionProps

### Community 255 - "$slug.tsx"
Cohesion: 0.67
Nodes (3): isCategorySlug(), CategoryRoute(), Route

### Community 256 - "CategoryProductCard.tsx"
Cohesion: 0.13
Nodes (12): CategoryPenProgram(), CategoryPenProgramProps, curvedPath(), pathsEqual(), CategoryProductCard(), CategoryProductCardProps, peptideToCatalogProduct(), CATALOG_PRODUCTS (+4 more)

## Knowledge Gaps
- **877 isolated node(s):** `checks`, `$schema`, `style`, `rsc`, `tsx` (+872 more)
