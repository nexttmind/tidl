# Graph Report - tidl_webiste  (2026-07-17)

## Corpus Check
- 239 files · ~5,570,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1868 nodes · 3070 edges · 246 communities (119 shown, 127 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91a70e11`
...
## Communities (246 total, 127 thin omitted)
...
Cohesion: 0.04
Nodes (72): PDP_META, getRouter(), Route, Route, Route, Route, Route, Route (+64 more)

### Community 2 - "Checkout UI Components"
Cohesion: 0.07
Nodes (34): ASSURANCE, BIOMARKERS, buildGoals(), GOAL_COPY, GOAL_PEPTIDES, GoalCard, PATHWAY_STEPS, ServicesSection() (+26 more)

### Community 3 - "Dynamic Quiz Logic"
Cohesion: 0.06
Nodes (65): answerMatches(), Answers, AnswerValue, AUTO_ADVANCE, DynamicQuiz(), FIELD_TYPE, fieldIsComplete(), FieldRenderer() (+57 more)
...
Cohesion: 0.23
Nodes (11): DynamicQuizModal(), useIsMounted(), clearQuizState(), getInitialQuizData(), isQuizComplete(), readQuizState(), useQuizModal(), CheckoutPage() (+3 more)
...
Cohesion: 0.13
Nodes (13): CategoryPenProgram(), CategoryPenProgramProps, curvedPath(), pathsEqual(), CategoryProductCard(), CategoryProductCardProps, peptideToCatalogProduct(), CATALOG_PRODUCTS (+5 more)
...
Cohesion: 0.18
Nodes (8): CATEGORY_BUNDLES, CategoryBundle, CategoryBundleItem, CATEGORY_PATHS, SERVICE_CARDS, ServiceCardContent, SERVICES_INTRO, SITE_IMAGES
...
Cohesion: 0.05
Nodes (46): BeforeAfterSlider(), BeforeAfterSliderProps, PdpButton(), PdpButtonProps, Reveal(), settle, LEFT_STATS, PdpBeforeAfterSection() (+38 more)
...
Cohesion: 0.15
Nodes (21): STATUS_ORDER, StatusTimeline(), addDays(), createOrder(), generateOrderNumber(), getOrderById(), getOrdersForUser(), readOrders() (+13 more)
...
Cohesion: 0.09
Nodes (33): GLP1_PDP_CONTENT, SHARED_CARE_FAQ, SHARED_DELIVERY_FAQ, SHARED_REVIEW_STATS, SHARED_SAFETY_PILLARS, SHARED_START_FAQ, HERO_IMAGES, getPdpContent() (+25 more)
...
Cohesion: 0.10
Nodes (23): CategoryAmbient(), CategoryExperienceSection(), ease, Props, CategoryFaqSection(), CategoryFaqSectionProps, CategoryPage(), CategoryPageProps (+15 more)
...
Cohesion: 0.13
Nodes (18): CategoryFormularySection(), CategoryFormularySectionProps, TileCopy(), tileImage(), tilePrice(), CATEGORY_NAME_RULES, CategoryCatalogItem, countCatalogByCategory() (+10 more)
...
Cohesion: 0.10
Nodes (25): CategorySandboxDetailDrawer(), CategorySandboxDetailDrawerProps, CHECKOUT_STEPS, CheckoutLayout(), HomePage(), FunnelPageShell(), FunnelPageShellProps, FUNNEL_NAV_LINKS (+17 more)
...
Cohesion: 0.12
Nodes (19): CategoryWhySection(), CategoryWhySectionProps, formatMetric(), ProofMetric, protocolLabel(), getPeptideDef(), PEPTIDE_DEFS, mergeSandboxIntoPdp() (+11 more)
...
Cohesion: 0.21
Nodes (14): PrxActivityCard(), CheckoutForm(), OrderSummary(), getLatestOrderForUser(), fetchPrxEncounters(), prxStatusLabel(), prxStatusToOrderStatus(), calculateOrderPricing() (+6 more)

### Community 98 - "types.ts"
Cohesion: 0.16
Nodes (9): FAQ_DATA, FaqItem, JOURNEY_TICKER_ICONS, JOURNEY_TICKER_ITEMS, JourneySection(), JourneySectionProps, HERO_COPY, HOMEPAGE_STARTING_PRICE_LABEL (+1 more)
...
Cohesion: 0.20
Nodes (13): CategoryRecommendation, findAnswer(), getCategoryRecommendation(), resolveAction(), GENERIC_FALLBACK_PRODUCT, GLP1_PRODUCT, GOAL_FALLBACK, Product (+5 more)
...
Cohesion: 0.13
Nodes (17): catCardHover, catReveal, catSpring, catStagger, CategoryAfterSection(), CategoryAfterSectionProps, CategoryBundleSection(), CategoryBundleSectionProps (+9 more)
...
- **Why does `dependencies` connect `clsx` to `Linting and Formatting`, `DynamicQuiz.tsx`, `3.3 Spacing system`, `@hookform/resolvers`, `Chart and Carousel Logic`, `checkout.tsx`, `@radix-ui/react-tooltip`, `data.ts`, `site-assets.ts`, `schema-intake.ts`, `auth.tsx`, `quiz-sandbox.tsx`, `@radix-ui/react-collapsible`, `Route`, `Community 167`, `Drawer UI Components`, `@tailwindcss/vite`, `OTP Input Library`, `Icon Library`, `Radix Accordion Primitive`, `Radix Aspect Ratio Primitive`, `input-otp`, `Radix Context Menu Primitive`, `Radix Dialog Primitive`, `Radix Dropdown Primitive`, `Radix Label Primitive`, `Radix Navigation Primitive`, `Radix Progress Primitive`, `Radix Scroll Area Primitive`, `Radix Slider Primitive`, `Radix Toggle Group Primitive`, `Date Picker Library`, `React DOM Library`, `React Form Library`, `React Spring Animations`, `Sonner Toast Library`, `React Query Library`, `PdpBeforeAfterSection.tsx`, `TanStack Router Plugin`, `@radix-ui/react-popover`, `Tailwind Animation CSS`, `Vite TSConfig Paths`, `@radix-ui/react-select`, `tailwind-merge`, `@tanstack/react-router`, `Zod Schema Validation`, `playwright`, `@radix-ui/react-menubar`, `@radix-ui/react-tabs`, `react-resizable-panels`, `recharts`, `embla-carousel-react`?**
