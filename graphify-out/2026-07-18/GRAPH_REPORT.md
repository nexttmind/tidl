# Graph Report - tidl_webiste  (2026-07-18)

## Corpus Check
- 241 files · ~6,252,668 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1872 nodes · 3077 edges · 248 communities (121 shown, 127 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47c48dbd`
...
Cohesion: 0.24
Nodes (10): CategorySandboxDetailDrawer(), CategorySandboxDetailDrawerProps, CheckoutLayout(), HomePage(), FunnelPageShell(), FunnelPageShellProps, AgeGateState, lockPageScroll() (+2 more)

### Community 3 - "Dynamic Quiz Logic"
Cohesion: 0.05
Nodes (55): PrxActivityCard(), answerMatches(), Answers, AnswerValue, AUTO_ADVANCE, DynamicQuiz(), FIELD_TYPE, fieldIsComplete() (+47 more)
...
Cohesion: 0.17
Nodes (11): FAQ_DATA, FaqItem, HERO_COPY, HOMEPAGE_STARTING_PRICE_LABEL, peptideToProduct(), useHomeSandbox(), GENERIC_FALLBACK_PRODUCT, getProductBySlug() (+3 more)
...
Cohesion: 0.05
Nodes (44): BeforeAfterSlider(), BeforeAfterSliderProps, IncludedItem, TimelineStep, PdpButton(), PdpButtonProps, Reveal(), settle (+36 more)
...
Cohesion: 0.12
Nodes (21): OrderSummary(), calculateOrderPricing(), getCatalogListPrice(), approximateDobFromAge(), mapCheckoutToPatientAddressPayload(), mapCheckoutToPaymentPayload(), mapCheckoutToUnifiedIntakePayload(), mapQuizToConsents() (+13 more)
...
Cohesion: 0.08
Nodes (34): GLP1_PDP_CONTENT, SHARED_CARE_FAQ, SHARED_DELIVERY_FAQ, SHARED_REVIEW_STATS, SHARED_SAFETY_PILLARS, SHARED_START_FAQ, HERO_IMAGES, PDP_META (+26 more)
...
Cohesion: 0.23
Nodes (11): CATEGORY_NAME_RULES, CategoryCatalogItem, countCatalogByCategory(), getProductSlugsForCategory(), getUnmappedProductSlugs(), inferFormHint(), inferStrengthLabel(), mapSandboxProductToCategory() (+3 more)
...
Cohesion: 0.09
Nodes (27): CategoryAmbient(), CategoryExperienceSection(), ease, Props, CategoryFormularySection(), CategoryFormularySectionProps, TileCopy(), tileImage() (+19 more)
...
Cohesion: 0.23
Nodes (15): STATUS_ORDER, StatusTimeline(), DynamicQuizModal(), useIsMounted(), usePrxEncounterStatus(), getLatestOrderForUser(), prxStatusToOrderStatus(), getRecommendedTreatment() (+7 more)

### Community 66 - "Form Validation Resolvers"
Cohesion: 0.46
Nodes (7): addDays(), createOrder(), generateOrderNumber(), getOrderById(), getOrdersForUser(), readOrders(), writeOrders()
...
Cohesion: 0.15
Nodes (12): CHECKOUT_STEPS, FUNNEL_NAV_LINKS, SiteFooter(), SiteHeader(), SiteHeaderProps, SiteNavLink, readSectionTheme(), SiteHeaderTheme (+4 more)
...
Cohesion: 0.14
Nodes (5): AuthPage(), AuthPageProps, useTypewriterLoop(), authSearchSchema, Route

### Community 98 - "types.ts"
Cohesion: 0.06
Nodes (40): CategoryWhySection(), CategoryWhySectionProps, formatMetric(), ProofMetric, protocolLabel(), CareMosaicSection(), CareMosaicSectionProps, PATHWAYS (+32 more)
...
Cohesion: 0.14
Nodes (10): CategoryHowSectionProps, chipEase, PATH_COPY, PathCopy, titleEase, CategoryPenSectionProps, GLP1_PEN_SHOWCASE, PenShowcaseContent (+2 more)

### Community 165 - "Community 165"
Cohesion: 0.20
Nodes (11): AskTidlSection, AskTidlSectionHandle, BotPhase, ASK_TIDL_ANSWERS, ASK_TIDL_PLACEHOLDER_QS, ASK_TIDL_PROMPTS, ASK_TIDL_SECTION, CategoryRecommendation (+3 more)
...
Cohesion: 0.12
Nodes (16): catCardHover, catReveal, catStagger, CategoryAfterSection(), CategoryAfterSectionProps, CategoryFaqSection(), CategoryFaqSectionProps, CategoryHero() (+8 more)

### Community 247 - "ServicesSection.tsx"
Cohesion: 0.14
Nodes (10): buildGoals(), GOAL_COPY, GOAL_IMAGES, GoalCard, ServicesSection(), CATEGORY_SLUGS, CATEGORY_PATHS, SERVICE_CARDS (+2 more)
...
### Community 255 - "pricing.ts"
Cohesion: 0.22
Nodes (9): getPdpContent(), PdpHeroSection(), PdpHeroSectionProps, Glp1PdpPage(), ProductPdpPageInner(), ProductPdpPageProps, mergeSandboxIntoPdp(), usableLiveCopy() (+1 more)

### Community 256 - "CategoryProductCard.tsx"
Cohesion: 0.09
Nodes (20): catSpring, CategoryBundleSection(), CategoryBundleSectionProps, CategoryPenProgram(), CategoryPenProgramProps, curvedPath(), pathsEqual(), CategoryProductCard() (+12 more)

## Knowledge Gaps
- **880 isolated node(s):** `checks`, `$schema`, `style`, `rsc`, `tsx` (+875 more)
...
- **Why does `dependencies` connect `clsx` to `Linting and Formatting`, `DynamicQuiz.tsx`, `3.3 Spacing system`, `@hookform/resolvers`, `Chart and Carousel Logic`, `checkout.tsx`, `data.ts`, `site-assets.ts`, `schema-intake.ts`, `auth.tsx`, `quiz-sandbox.tsx`, `@radix-ui/react-collapsible`, `Route`, `Community 167`, `Drawer UI Components`, `@tailwindcss/vite`, `OTP Input Library`, `Icon Library`, `Radix Accordion Primitive`, `Radix Aspect Ratio Primitive`, `input-otp`, `Radix Context Menu Primitive`, `Radix Dialog Primitive`, `Radix Dropdown Primitive`, `Community 208`, `Radix Label Primitive`, `Radix Navigation Primitive`, `encounter-schema.ts`, `Radix Scroll Area Primitive`, `Radix Separator Primitive`, `Radix Slider Primitive`, `Radix Toggle Group Primitive`, `Date Picker Library`, `React DOM Library`, `React Form Library`, `React Spring Animations`, `Sonner Toast Library`, `React Query Library`, `PdpBeforeAfterSection.tsx`, `TanStack Router Plugin`, `@radix-ui/react-popover`, `Tailwind Animation CSS`, `Vite TSConfig Paths`, `@radix-ui/react-select`, `tailwind-merge`, `@tanstack/react-router`, `Zod Schema Validation`, `playwright`, `@radix-ui/react-menubar`, `@radix-ui/react-tabs`, `react-resizable-panels`, `recharts`?**
