# Graph Report - tidl_webiste  (2026-07-20)

## Corpus Check
- 241 files · ~6,664,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1871 nodes · 3080 edges · 259 communities (132 shown, 127 thin omitted)
...
Cohesion: 0.13
Nodes (20): answerMatches(), Answers, AnswerValue, AUTO_ADVANCE, DynamicQuiz(), FIELD_TYPE, fieldIsComplete(), FieldRenderer() (+12 more)

### Community 1 - "App Routing and Pages"
Cohesion: 0.04
Nodes (71): getRouter(), Route, Route, Route, Route, Route, Route, Route (+63 more)

### Community 2 - "Checkout UI Components"
Cohesion: 0.17
Nodes (14): catCardHover, catReveal, catSpring, catStagger, AFTER_IMAGES, CategoryAfterSection(), CategoryAfterSectionProps, CategoryBundleSection() (+6 more)

### Community 3 - "Dynamic Quiz Logic"
Cohesion: 0.12
Nodes (24): ApiFailure, ApiSuccess, fetchPrxAuthMe(), fetchPrxCatalog(), fetchPrxCatalogProducts(), fetchPrxCatalogSnapshot(), fetchPrxHealth(), fetchPrxOrder() (+16 more)
...
Cohesion: 0.22
Nodes (9): HERO_COPY, HOMEPAGE_STARTING_PRICE_LABEL, peptideToProduct(), useHomeSandbox(), GENERIC_FALLBACK_PRODUCT, getProductBySlug(), GLP1_PRODUCT, GOAL_FALLBACK (+1 more)
...
Cohesion: 0.33
Nodes (6): createPrxClient(), IntakeBody, handlePrxRouteError(), jsonError(), jsonOk(), readJsonBody()
...
Cohesion: 0.10
Nodes (31): CategoryAmbient(), CategoryFormularySection(), CategoryFormularySectionProps, resolvePdpSlug(), TileCopy(), tileImage(), tilePrice(), CategoryPage() (+23 more)
...
Cohesion: 0.06
Nodes (39): BeforeAfterSlider(), BeforeAfterSliderProps, PdpButton(), PdpButtonProps, Reveal(), settle, PdpBeforeAfterSection(), PdpBeforeAfterSectionProps (+31 more)

### Community 23 - "Environment Configuration"
Cohesion: 0.11
Nodes (30): createRoleClient(), prxClient(), prxPatient(), prxProvider(), prxSalesOrg(), PrxEncounterTypeSchema, PrxEncounterTypeSchemaResponse, PrxEncounterTypesResponse (+22 more)

### Community 24 - "UI Library Dependencies"
Cohesion: 0.24
Nodes (12): OrderSummary(), useIsMounted(), usePrxEncounterStatus(), prxStatusToOrderStatus(), calculateOrderPricing(), formatCurrency(), getCatalogListPrice(), getRecommendedTreatment() (+4 more)
...
Cohesion: 0.20
Nodes (15): SHARED_CARE_FAQ, SHARED_DELIVERY_FAQ, SHARED_REVIEW_STATS, SHARED_SAFETY_PILLARS, SHARED_START_FAQ, PdpMarketing, PdpPageContent, buildGlp1Marketing() (+7 more)
...
Cohesion: 0.25
Nodes (6): CategoryHowSectionProps, chipEase, PATH_COPY, PathCopy, titleEase, CategoryTimelineStep
...
Cohesion: 0.16
Nodes (13): CategoryWhySection(), CategoryWhySectionProps, formatMetric(), ProofMetric, protocolLabel(), fetchPrxEncounterTypes(), PrxEncounterTypeSummary, ALL_ENCOUNTER_SLUGS (+5 more)
...
Cohesion: 0.14
Nodes (18): CategorySandboxDetailDrawer(), CategorySandboxDetailDrawerProps, CheckoutLayout(), FAQ_DATA, FaqItem, HOME_PULSE, HomePage(), FunnelPageShell() (+10 more)
...
Cohesion: 0.12
Nodes (17): isProductSlug(), ProductRoute(), Route, EATING_HABITS, EatingHabits, EXERCISE_LEVELS, ExerciseLevel, GOAL_IDS (+9 more)
...
Cohesion: 0.22
Nodes (8): GLP1_PDP_CONTENT, HERO_IMAGES, getPdpContent(), PDP_META, PDP_REGISTRY, withCatalogAssets(), peptideToPdpMeta(), Route
...
Cohesion: 0.21
Nodes (9): PrxActivityCard(), State, fetchPrxEncounter(), fetchPrxEncounters(), PrxEncounter, PrxEncounterResponse, PrxEncountersResponse, PrxPaginated (+1 more)
...
Cohesion: 0.16
Nodes (13): FaqItem, HeroProduct, IncludedItem, PdpBeforeAfter, PenShowcaseFeature, PenShowcaseStat, ReviewStat, SafetyPillar (+5 more)

### Community 84 - "encounter-schema.ts"
Cohesion: 0.20
Nodes (7): CategoryFaqSection(), CategoryFaqSectionProps, CategoryTrustSection(), CategoryTrustSectionProps, TRUST_IMAGES, TRUST_LINE, CategoryDefinition
...
Cohesion: 0.13
Nodes (6): AuthBrandPanel(), AuthPage(), AuthPageProps, useTypewriterLoop(), authSearchSchema, Route

### Community 91 - "checkout.tsx"
Cohesion: 0.41
Nodes (9): isPrxSandbox(), DynamicIntakeBody, extractEncounterId(), extractEncounterNumber(), extractOrderId(), extractPatientChartId(), extractPatientNumber(), unwrapPrxEntity() (+1 more)

### Community 96 - "React Spring Animations"
Cohesion: 0.18
Nodes (7): CategoryExperienceSection(), ease, Props, CareMosaicSection(), CareMosaicSectionProps, PATHWAYS, CategorySlug

### Community 98 - "types.ts"
Cohesion: 0.15
Nodes (18): getPeptideImageMap(), CATALOG_KEYWORDS, PrxCatalogPackage, PrxCatalogProduct, mergeSandboxIntoPdp(), usableLiveCopy(), buildState(), firstPositiveSandboxPrice() (+10 more)
...
Cohesion: 0.33
Nodes (4): LeaderPath, PEN_FEATURES, PenCalloutStage, PenFeature
...
Cohesion: 0.29
Nodes (7): AskTidlSection, AskTidlSectionHandle, BotPhase, ASK_TIDL_ANSWERS, ASK_TIDL_PLACEHOLDER_QS, ASK_TIDL_PROMPTS, ASK_TIDL_SECTION
...
Cohesion: 0.22
Nodes (6): AuthBrandPanelProps, AuthMode, CATEGORY_BUNDLES, CategoryBundle, CategoryBundleItem, SITE_IMAGES
...
Cohesion: 0.18
Nodes (8): TidlWordmark(), TidlWordmarkProps, CAREER_LINKS, COMPANY_LINKS, SiteFooterProps, SOCIAL_LINKS, TREATMENT_LINKS, SOCIAL_ICONS

### Community 249 - "PdpReviewsSection.tsx"
Cohesion: 0.33
Nodes (4): CategoryHero(), CategoryHeroProps, HERO_IMAGES, HERO_TRUTHS

### Community 251 - "schema-intake.ts"
Cohesion: 0.20
Nodes (10): buildGallery(), PdpHeroSection(), PdpHeroSectionProps, resolvePeptideOnlyImage(), peptideToCatalogProduct(), CATALOG_PRODUCTS, getCatalogPrice(), getCatalogProduct() (+2 more)

### Community 253 - "PdpSandboxFactsSection.tsx"
Cohesion: 0.40
Nodes (3): CategoryPenSectionProps, GLP1_PEN_SHOWCASE, PenShowcaseContent

### Community 255 - "JourneySection.tsx"
Cohesion: 0.33
Nodes (4): JOURNEY_TICKER_ICONS, JOURNEY_TICKER_ITEMS, JourneySection(), JourneySectionProps
...
Cohesion: 0.40
Nodes (4): CATEGORY_PATHS, SERVICE_CARDS, ServiceCardContent, SERVICES_INTRO

## Knowledge Gaps
- **879 isolated node(s):** `checks`, `$schema`, `style`, `rsc`, `tsx` (+874 more)
